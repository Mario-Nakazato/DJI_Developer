...
public class CaptureArea {
    ...
    private static double altura = 16; // m
    ...
    private static double footprintLargura = altura * sensorLargura / distanciaFocal; // m
    ...
    private static double footprintAltura = altura * sensorAltura / distanciaFocal; // m
    ...
    static void setAltura(double alt) {
        if (alt < 0)
            return;
        altura = alt;
    ...
    static void setFootprintLargura(double footprintLar) {
        ...
        setAltura(sensorLargura != 0 ? footprintLargura * distanciaFocal / sensorLargura : 0);
    }

    private static void calcFootprintLargura() {
        footprintLargura = distanciaFocal != 0 ? altura * sensorLargura / distanciaFocal : 0;
        calcGsdLargura();
    }
    ...
    static void setFootprintAltura(double footprintAlt) {
        ...
        setAltura(sensorAltura != 0 ? footprintAltura * distanciaFocal / sensorAltura : 0);
    }

    private static void calcFootprintAltura() {
        footprintAltura = distanciaFocal != 0 ? altura * sensorAltura / distanciaFocal : 0;
        calcGsdAltura();
    }
